        ...
        {phoneMode ? (
          ...
          <>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <SocialBtn onClick={handleMicrosoft} loading={loadingBtn==='microsoft'} disabled={busy} icon={<MicrosoftIcon />} label="Microsoft" cls="bg-[#2f2f2f] border border-gray-600 col-span-2" />
              <SocialBtn onClick={() => setPhoneMode(true)} loading={false} disabled={busy} icon={<PhoneIcon />} label="Phone / WhatsApp" cls="bg-[#25D366] col-span-2" />
            </div>
